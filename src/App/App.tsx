                ...
                <div>
                    <header>
                        <img
                            className="c-logo"
                            src={logo}
                            alt="Robby Brosman logo"
                        />
                    </header>
                    <div className="c-blurb">
                        <p>
                            Hi, my name is Robby. I{' '}
                            <a href="https://www.brewersfriend.com/homebrew/brewer/88086/robbybro">
                                brew a lot of beer
                            </a>{' '}
                            and{' '}
                    ...
                    <div className="c-projects">{projectElements}</div>
                    <SpeedDial>
                        <BubbleList>{listElements}</BubbleList>
                    </SpeedDial>
                    <footer>
                        &copy; {new Date().getFullYear()} Robby Brosman
                    </footer>
                </div>
            </MuiThemeProvider>
        );
